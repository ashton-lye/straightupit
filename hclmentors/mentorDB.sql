--MySQL database creation script, created by Ashton Lye
...
('2018-11-23', 10, 'david', '021234567', 'send email', 'client successfully sent email', 'windows', 'false', 'false', 'jpaul1', 'Central'),
('2018-11-23', 11, 'steve', '021134567', 'send txt', 'client successfully learned how to text', 'android', 'false', 'false', 'jpaul1', 'Central'),
('2018-11-22', 11, 'bob', '0212234567', 'send email', 'client added email to mail client, learned how to send emails', 'macos', 'false', 'false', 'bnye3', 'Central'),
('2018-11-22', 13, 'dale', '021334567', 'print', 'printer was added incorrectly, fixed and client could print', 'windows', 'false', 'false', 'clee4', 'Central'),
('2018-11-26', 11, 'anna', '021234567', 'send email', 'client forgot email password, reset and successfully sent emails', 'windows', 'false', 'false', 'jpaul1', 'Central'),
('2018-11-26', 12, 'joe', '0219876543', null, 'client didnt show up', null, 'true', 'false', 'jpaul1', 'Central'),
('2018-11-26', 13, 'cheryl', '021134567', 'install app', 'showed client the app store, they installed app and learned how to get more', 'ios', 'false', 'false', 'jpaul1', 'Central'),
('2018-11-27', 10, 'stacy', '0212923456', 'send email with pictures', 'client learned how to attach images to email', 'android', 'false', 'false', 'bnye3', 'Central'),
('2018-11-27', 11, 'bob', '0212234567', 'how to take video', 'client learned how to take photos/videos and also taught how to use facetime (client requested)', 'ios', 'false', 'false', 'bnye3', 'Central'),
('2018-11-28', 10, 'nate', '0217223456', 'learn how to skype', 'installed skype, created client account and taught them how to call people', 'windows', 'false', 'false', 'bnye3', 'Central'),
('2018-11-28', 11, null, null, null, 'showed customer how to print', 'windows', 'false', 'true', 'bnye3', 'Central');
